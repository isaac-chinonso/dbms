...
@section('title')
All Students || Information Management System
@endsection
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">STUDENTS LIST</h4>
                    </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped" data-filtering="true" data-paging="true" data-sorting="true">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>                                             
                                                    @if($stud->status == 1)
                                                        <span class="label label-table label-danger"><a href="#" data-toggle="modal" data-target="#activate{{ $stud->id }}" style="color:#fff;">Archived</a></span>
                                                    @endif
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <p>Are you sure you want to Deactivate {{ $stud->fullname }}</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary waves-effect" data-dismiss="modal">Close</button>
                                                                    <a href="{{ route('deactivatestudent',$stud->id) }}" class="btn btn-success waves-effect waves-light">Yes</a>
                                                                </div>
                                                            </div><!-- /.modal-content -->
                                                        </div><!-- /.modal-dialog -->
                                                    </div><!-- /.modal -->
