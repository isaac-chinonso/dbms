...
@section('title')
Add General Report || Information Management System
@endsection
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">ADD GENERAL REPORTS</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <h5 class="card-title text-uppercase">ADD GENERAL REPORT</h5>
                                <form class="form-material m-t-40" method="post" action="{{ url('/save-general-report')}}">
