            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Complete Profile</h4>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" method="post" enctype="multipart/form-data" action="{{ url('/student/save-profile') }}">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                @endif
                                                <input type="text" name="fullname" class="form-control" placeholder="enter your fullname" value="{{ Request::old('fullname')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="matric" class="form-control" placeholder="enter your matric no" value="{{ Request::old('matric')}}" required>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="program" class="form-control mydatepicker" placeholder="enter program type" value="{{ Request::old('program')}}" required>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="year_admitted" class="form-control" placeholder="enter year you were admitted" value="{{ Request::old('year_admitted')}}" required>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="duration" class="form-control" placeholder="enter program duration" value="{{ Request::old('duration')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="nationality" class="form-control" placeholder="enter nationality" value="{{ Request::old('nationality')}}" required>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="state" class="form-control" placeholder="enter state of origin" value="{{ Request::old('state')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                @endif
                                                <input type="text" name="religion" class="form-control" placeholder="enter your religion" value="{{ Request::old('religion')}}" required>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                @endif
                                                <textarea class="form-control" rows="3" name="address">{{ Request::old('address')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Save Profile</button>
